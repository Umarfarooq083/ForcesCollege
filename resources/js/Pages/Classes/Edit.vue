...
const form = useForm({
    id: props.classesList.id,
    ClassName: props.classesList.ClassName,
    ClassOrder: props.classesList.ClassOrder,
    class_type_id: props.classesList.class_type_id,
});
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <form @submit.prevent="form.post(route('class.update'))">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
