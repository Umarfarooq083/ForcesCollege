...
const form = useForm({
    id: props.examType.id,
    ExamName: props.examType.ExamName,
    SessionId: props.currentSession.id,
    ExamTermId: props.examType.ExamTermId,
    ResultDeclarationDate: props.examType.ResultDeclarationDate,
    Description: props.examType.Description,
    IsPublishResult: props.examType.IsPublishResult,
});
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Edit Exam</h2>
        </template>
       
       <form @submit.prevent="form.put(route('examtype.update'))">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">Edit Exam</div>
                        <div class="body">
                            <div class="row">
