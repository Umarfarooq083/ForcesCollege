...
const dailyFeeCollectionReport = async () => {
    if (!form.value.month) {
    ...
    try {
        const response = await axios.get(
            route('fee.dailycollection.fetch'),
            {
                params: {
                    ...
                    <div class="card cstm_shadow border-0 h-100">
                        <div class="card-body d-flex flex-column">
                            <div class="d-flex align-items-center mb-3">
                                <h5 class="card-title mb-0">Daily Fee Collection</h5>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" v-model="form.month" />
                                    </div>
                                </div>
                                ...
                                <div class="text-right" style="margin-top: 30px;">
                                    <button
                                        ...
                                        @click="dailyFeeCollectionReport"
                                        :disabled="loading"
                                    >
            ...
            <div class="modal-dialog modal-xxl modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Daily Fee Collection</h5>
