...
const form = useForm({
    ...
    weekend_day: props.holiday.weekend_day || 'both',
    is_active: props.holiday.is_active ?? true,
});
</script>

<template>
    <Head title="Edit Campus Weekly Holiday" />
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Edit Campus Weekly Holiday</h2>
        </template>

        <form @submit.prevent="form.post(route('campus-weekly-holiday.update'))">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">Edit Campus Weekly Holiday Configuration</div>
                        <div class="body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
