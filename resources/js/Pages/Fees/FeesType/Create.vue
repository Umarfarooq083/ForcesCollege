...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">New Fee Type</h2>
        </template>
        <form @submit.prevent="form.post(route('fees.submit'))">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">New Fee Type</div>
                        <div class="body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-2" style="margin-top: 32px;" >
                                 ...
                                 <div class="col-md-2" style="margin-top: 32px;" v-if="form.FeeCycle !== 'Monthly'">
                                    <div class="mb-3">
                                         <label class="fancy-checkbox element-left">	
                                 ...
                                 <div class="col-md-2" style="margin-top: 32px;" v-if="form.FeeCycle !== 'Monthly' && form.FeeCycle !== 'Once' ">
                                    <div class="mb-3">
                                         <label class="fancy-checkbox element-left">	
