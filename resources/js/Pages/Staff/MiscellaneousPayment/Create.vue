...
<template>
    <Head title="Create Miscellaneous Payment" />
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Create Miscellaneous Payment</h2>
        </template>

        <form @submit.prevent="form.post(route('miscellaneouspayment.submit'))">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">Create Miscellaneous Payment</div>
                        <div class="body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
