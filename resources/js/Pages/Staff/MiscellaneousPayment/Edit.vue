...
const form = useForm({
    id: props.miscellaneousPayment.id,
    staff_id: props.miscellaneousPayment.staff_id,
    apply_year: props.miscellaneousPayment.apply_year,
    applicable_month: props.miscellaneousPayment.applicable_month,
    amount: props.miscellaneousPayment.amount,
    reason: props.miscellaneousPayment.reason,
});
</script>

<template>
    <Head title="Edit Miscellaneous Payment" />
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Edit Miscellaneous Payment</h2>
        </template>

        <form @submit.prevent="form.put(route('miscellaneouspayment.update'))">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">Edit Miscellaneous Payment</div>
                        <div class="body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
