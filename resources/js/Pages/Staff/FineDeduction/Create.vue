...
<template>
    <Head title="Create Fine Deduction" />
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Create Fine Deduction</h2>
        </template>

        <form @submit.prevent="form.post(route('finededuction.submit'))">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="header">Create Fine Deduction</div>
                        <div class="body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
