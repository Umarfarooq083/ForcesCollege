                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <InputLabel value="For Session" />
                                         <select class="form-control" disabled v-model="form.SessionId">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <TextInput type="date" v-model="form.Date" disabled class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" disabled v-model="form.ClassId">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <TextInput type="text" disabled v-model="form.Name" class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <TextInput type="text" disabled v-model="form.LastName" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <InputLabel value="Date of Birth *" />
                                        <TextInput type="date" disabled v-model="form.BirthDate" class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" disabled v-model="form.Gender">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <TextInput type="text" disabled v-model="form.PreviousInstitute" class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <TextInput type="text" disabled v-model="form.Address" class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <TextInput type="text" disabled v-model="form.FatherName" class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <TextInput type="text" disabled v-model="form.cnic" class="form-control" readonly/>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" disabled v-model="form.guardian_relation_id">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <TextInput type="text" disabled v-model="form.FatherPhoneNo" class="form-control" @input="form.FatherPhoneNo = formatPhone(form.FatherPhoneNo)"/>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <TextInput type="text" disabled v-model="form.MotherName" class="form-control" />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <TextInput type="text" disabled v-model="form.MotherPhoneNo" class="form-control" @input="form.MotherPhoneNo = formatPhone(form.MotherPhoneNo)"/>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" disabled v-model="form.SourceId">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" disabled v-model="form.ReferenceId">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="checkbox" disabled v-model="form.IsSmsSent" />
